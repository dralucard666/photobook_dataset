    ...
    for key in json_data:
        ...
        if os.path.exists(image_path):
            ...
            object = {
                ...
                "messages": [message["Message_Text"] for message in json_data[key]],
                "all_images": [message["All_Images"] for message in json_data[key]],
            }
...
def encode_obj(all_objects):
    ...
    for obj in tqdm(all_objects):
        ...
        encoding = tokenizer(
            obj["messages"], padding=True, truncation=True, return_tensors="pt"
        )
